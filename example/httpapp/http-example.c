...
// on line
    #define IOTX_PRODUCT_KEY         "a1NfWfYaCVd"
    #define IOTX_DEVICE_NAME         "MQTT_base_test01"
    #define IOTX_DEVICE_SECRET       "JLVYa7kGvBZQaRInfVYLAHYjfvwpKnmC"
    #define IOTX_DEVICE_ID           "MQTT_base_test01"
